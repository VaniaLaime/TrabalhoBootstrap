...
<html lang="pt-br">
  ...
  <body>
   ...
   <div class="container center my-3">
      <h1 class="display-4 text-muted">Exercicio 3</h1>
    <form method="post">
        <div class="form-group">
          <div class="col-sm-5">
		        <input type="text" name="txSalarioM"  class="form-control" placeholder="digite o salario atual" />	
          </div>
        

        <div class="form-group">
          <div class="col-sm-5">
		        <input type="text" name="txPReajuste" class="form-control" placeholder=" digite reajuste em (%)" /> 
          </div>
      </div>  
